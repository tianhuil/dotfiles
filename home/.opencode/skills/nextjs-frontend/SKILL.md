...
- **Modern React patterns** - leverage React 19 features and hooks appropriately
...
- **[Next.js 16 Features](reference/nextjs-16-features.md)** - Async params, caching APIs, Cache Components, Turbopack, React Compiler

- **[Design System](reference/design-system.md)** - Color system, typography, Tailwind patterns, design tokens, font setup

- **[Data Fetching & State](reference/data-fetching.md)** - Server components, SWR patterns, React 19 features, caching strategies
